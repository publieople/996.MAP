...
- **搜索功能：** 实时搜索公司名称，快速定位目标公司
- **城市筛选：** 按城市筛选公司，查看特定地区情况
- **工作制度筛选：** 按工作制度类型（996/大小周/995 等）筛选
- **可折叠筛选面板：** 灵活控制界面显示，提升用户体验
- **自动化数据更新：** 每周自动从上游同步数据
...
- **公司名称搜索：** 在搜索框中输入公司名称，支持实时搜索和模糊匹配
- **快速定位：** 搜索结果会自动在地图上高亮显示匹配的公司

#### 筛选功能

- **城市筛选：** 从下拉列表中选择城市，查看特定地区的公司分布
- **工作制度筛选：** 按工作制度类型筛选，快速找到特定工作制的公司
  - 996/997/007：强制加班工作制
  - 大小周：隔周休息工作制
  - 995/10106：相对温和的加班制度
  - 其他/不明确：其他类型工作制度
...
- **自动应用：** 筛选条件变更后会自动更新地图显示
- **重置按钮：** 一键清除所有筛选条件，恢复显示全部公司
- **折叠面板：** 点击筛选面板右上角的"−/+"按钮可折叠或展开面板
- **结果计数：** 面板底部显示当前筛选结果数量和总数
